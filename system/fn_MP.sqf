...
with missionnamespace do {
	...
	AFAL_fnc_MP_packet = [0,_params,_functionName,_target,_isPersistent,_isCall];
	publicvariableserver "AFAL_fnc_MP_packet";
	if !(ismultiplayer) then {["AFAL_fnc_MP_packet",AFAL_fnc_MP_packet] spawn AFAL_fnc_MPexec;};
	AFAL_fnc_MP_packet
};
