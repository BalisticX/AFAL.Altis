...
//			["Patrol Car", 18990, "C_Offroad_01_F", "$18990"],			// Removed until vehicle shop sorted
			...
			["Unmanned Rover", 88250, "B_UGV_01_F", "$88250"]
		]	};
	
	case "PoliceHeli" : {	_array = _array + [
			["Helibird", 1850000, "B_Heli_Light_01_F", "$1850000"],
			["Scout Chopper", 2550000, "B_Heli_Attack_01_F", "$2550000"],
			["Police Transport", 5790000, "B_Heli_Transport_01_F", "$5790000"],
			["Heavy Lifter", 7850000, "B_Heli_Transport_03_unarmed_F", "$7850000"]
		]	};
	
	case "MedicCar" : {		_array = _array + [
			["Medic Quadbike", 5090, "I_Quadbike_01_F", "$5090"],
			["Ambulance", 50250, "I_MRAP_03_F", "$50250"],
			["Medical Truck", 42200, "I_Truck_02_medical_F", "$42200"]
		]	};
	
	case "MedicHeli" : {	_array = _array + [
			["Medivac Chopper", 102500, "I_Heli_light_03_unarmed_F", "$102500"],
			["Medical Transport", 145050, "I_Heli_Transport_02_F", "$145050"]
		]	};
	
	case "GangCar" : {		_array = _array + [
	...
	case "GangHeli" : {		_array = _array + [
			["Private Heli", 2100000, "O_Heli_Light_02_F", "$2100000"],
			["Air-Strike IV", 3250000, "O_Heli_Attack_02_F", "$3250000"]
		]	};
};
