...
class clothesShop {
	...
	class Uniforms : RscButton {
		...
		w = 0.155;		h = 0.07;
		text = "Uniforms";
		action = "['Uniforms'] spawn AFAL_fnc_clothesShop_switch";
		sizeEx = 0.04;
	...
	class Vests : RscButton {
		...
		w = 0.155;		h = 0.07;
		text = "Vests";
		action = "['Vests'] spawn AFAL_fnc_clothesShop_switch";
		sizeEx = 0.04;
	...
	class Headgear : RscButton {
		...
		w = 0.155;		h = 0.07;
		text = "Headgear";
		action = "['Headgear'] spawn AFAL_fnc_clothesShop_switch";
		sizeEx = 0.04;
	...
	class Facewear : RscButton {
		...
		w = 0.154;		h = 0.07;
		text = "Facewear";
		action = "['Facewear'] spawn AFAL_fnc_clothesShop_switch";
		sizeEx = 0.04;
	...
	class Backpacks : RscButton {
		...
		w = 0.155;		h = 0.07;
		text = "Backpacks";
		action = "['Backpacks'] spawn AFAL_fnc_clothesShop_switch";
		sizeEx = 0.04;
	...
	class Outfits : RscButton {
		...
		w = 0.155;		h = 0.07;
		text = "Outfits";
		action = "['Presets'] spawn AFAL_fnc_clothesShop_switch";
		sizeEx = 0.04;
